...
QUESTION_JSONL_PATH = "C:/Users/howto/Downloads/SemanticSearch/RagTestProject/testing/mineru/MergedProcessedMineru.jsonl"
OUTPUT_JSONL_PATH = "C:/Users/howto/Downloads/SemanticSearch/RagTestProject/testing/mineru/MineruAnswers.jsonl"
...
def main():
    ...
    for question in questions:
        ...
        try:
            response = client.get(
                ...
                params={
                    ...
                    "report_id": question.get("mineru_process")
                }
            )
        ...
        out = {
            ...
            "id": question.get("id"),
            "mineru_process": question.get("mineru_process"),
