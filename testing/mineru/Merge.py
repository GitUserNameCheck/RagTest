...
DOCUMENT_OBJECTS_FILE = "C:/Users/howto/Downloads/SemanticSearch/RagTestProject/testing/mineru/ProcessedMineru.jsonl"
OUTPUT_FILE = "C:/Users/howto/Downloads/SemanticSearch/RagTestProject/testing/mineru/MergedProcessedMineru.jsonl"
...
with open(OUTPUT_FILE, "w", encoding="utf-8") as out_f:
    for question in questions:
        ...
        for document in documents:
            ...
            record = {
                "id": document.get("id"),
                "mineru_process": document.get("mineru_process"),
